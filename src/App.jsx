...
const samplePrompts = [
  {
    ...
    model: 'GPT',
    tags: ['商品写真', '白背景', 'シンプル'],
    prompt: '[商品名]を白背景で撮影したシンプルな商品写真。自然光、清潔感、余計な文字やロゴなし。',
    memo: '商品や作品を見せたい時の基本形。まずはこれで十分。背景を盛りすぎない。',
    imageData: '',
  ...
  },
  {
    ...
    model: 'Gemini',
    tags: ['水彩', 'やさしい', '余白'],
    prompt: '[描きたいもの]を、やさしい透明水彩風で描く。淡い色、柔らかい線、白い余白、文字なし。',
    memo: '強い絵にしたくない時の基本。見出し画像や挿絵に使いやすい。',
    imageData: '',
  ...
  },
  {
    ...
    model: 'Grok',
    tags: ['SNS', '見出し', '余白'],
    prompt: '[投稿テーマ]についてのSNS投稿用画像。主役は左側、右側に文字を置ける余白。明るく見やすい雰囲気。画像内に文字は入れない。',
    memo: 'あとからCanvaなどで文字を入れたい時用。文字なし指定を忘れない。',
    imageData: '',
  ...
  },
  {
    ...
    category: '画像生成',
    model: 'Midjourney',
    tags: ['ブログ', 'アイキャッチ', '16:9'],
    prompt: '[記事の内容]を表すブログ用アイキャッチ画像。16:9、落ち着いた配色、シンプルな構図、文字なし、読みやすい余白あり。',
    memo: 'noteやSubstackの記事上部に置く用。説明しすぎず、内容の雰囲気だけ伝える。',
    imageData: '',
